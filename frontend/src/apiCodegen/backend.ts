...
export type PostUsersSelfSelfIdGameGuessSong201 = {
    /** A unique identifier for a popdle game. */
    gameId: number;
};
...
export type PutUsersSelfSelfIdConfigsPopdleConfigId404StatusCode =
    (typeof PutUsersSelfSelfIdConfigsPopdleConfigId404StatusCode)[keyof typeof PutUsersSelfSelfIdConfigsPopdleConfigId404StatusCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PutUsersSelfSelfIdConfigsPopdleConfigId404StatusCode = {
    NUMBER_404: 404,
} as const;
 ...
 * notFound
 */
export type PutUsersSelfSelfIdConfigsPopdleConfigId404 = {
    error: string;
    message: string;
    statusCode: PutUsersSelfSelfIdConfigsPopdleConfigId404StatusCode;
    [key: string]: unknown;
};

export type PutUsersSelfSelfIdConfigsPopdleConfigId401StatusCode =
    (typeof PutUsersSelfSelfIdConfigsPopdleConfigId401StatusCode)[keyof typeof PutUsersSelfSelfIdConfigsPopdleConfigId401StatusCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PutUsersSelfSelfIdConfigsPopdleConfigId401StatusCode = {
    NUMBER_401: 401,
} as const;
 ...
 * unauthorized
 */
export type PutUsersSelfSelfIdConfigsPopdleConfigId401 = {
    error: string;
    message: string;
    statusCode: PutUsersSelfSelfIdConfigsPopdleConfigId401StatusCode;
    [key: string]: unknown;
};

export type PutUsersSelfSelfIdConfigsPopdleConfigId200 = {
    /** The artists we can choose from, by their spotify ids. */
    fromArtists: string[];
    /** The tracks we can choose from, by their spotify ids. */
    fromTracks: string[];
...
export type DeleteUsersSelfSelfIdConfigsPopdleConfigId404StatusCode =
    (typeof DeleteUsersSelfSelfIdConfigsPopdleConfigId404StatusCode)[keyof typeof DeleteUsersSelfSelfIdConfigsPopdleConfigId404StatusCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DeleteUsersSelfSelfIdConfigsPopdleConfigId404StatusCode = {
    NUMBER_404: 404,
} as const;
 ...
 * notFound
 */
export type DeleteUsersSelfSelfIdConfigsPopdleConfigId404 = {
    error: string;
    message: string;
    statusCode: DeleteUsersSelfSelfIdConfigsPopdleConfigId404StatusCode;
    [key: string]: unknown;
};

export type DeleteUsersSelfSelfIdConfigsPopdleConfigId401StatusCode =
    (typeof DeleteUsersSelfSelfIdConfigsPopdleConfigId401StatusCode)[keyof typeof DeleteUsersSelfSelfIdConfigsPopdleConfigId401StatusCode];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DeleteUsersSelfSelfIdConfigsPopdleConfigId401StatusCode = {
    NUMBER_401: 401,
} as const;
 ...
 * unauthorized
 */
export type DeleteUsersSelfSelfIdConfigsPopdleConfigId401 = {
    error: string;
    message: string;
    statusCode: DeleteUsersSelfSelfIdConfigsPopdleConfigId401StatusCode;
    [key: string]: unknown;
};

export type DeleteUsersSelfSelfIdConfigsPopdleConfigId200 = {
    /** The artists we can choose from, by their spotify ids. */
    fromArtists: string[];
    /** The tracks we can choose from, by their spotify ids. */
    fromTracks: string[];
