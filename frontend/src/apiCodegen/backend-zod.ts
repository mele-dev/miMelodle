 ...
 */
export const postUsersSelfSelfIdFriendsLeaderboardsParams = zod.object({
    selfId: zod.number(),
});

export const postUsersSelfSelfIdFriendsLeaderboardsBodyModeRegExp = new RegExp(
    "^(guessLine|guessSong)$"
);

export const postUsersSelfSelfIdFriendsLeaderboardsBody = zod.object({}).and(
    zod.object({
        score: zod.number(),
        mode: zod
            .string()
            .regex(postUsersSelfSelfIdFriendsLeaderboardsBodyModeRegExp),
    })
);
 ...
 */
export const putUsersSelfSelfIdFriendsLeaderboardsPathGameModeRegExp =
    new RegExp("^(guessLine|guessSong)$");

export const putUsersSelfSelfIdFriendsLeaderboardsParams = zod.object({
    selfId: zod.number(),
    gameMode: zod
        .string()
        .regex(putUsersSelfSelfIdFriendsLeaderboardsPathGameModeRegExp),
});

export const putUsersSelfSelfIdFriendsLeaderboardsBody = zod.object({}).and(
    zod.object({
        score: zod.number(),
    })
);
...
export const getUsersSelfSelfIdGameGuessLineResponseGameModeRegExp = new RegExp(
    "^(guessLine|guessSong)$"
);
export const getUsersSelfSelfIdGameGuessLineResponseConfigModeRegExp =
    new RegExp("^(guessLine|guessSong)$");
...
export const getUsersSelfSelfIdGameGuessLineResponse = zod.object({
            ...
            zod.array(
                zod.object({
                    guessedLine: zod
                        .string()
                        .max(
                            getUsersSelfSelfIdGameGuessLineResponseAttemptsItemGuessedLineMax
                        ),
                    guessedAt: zod.string().datetime(),
                })
            )
    ...
    gameMode: zod
        .string()
        .regex(getUsersSelfSelfIdGameGuessLineResponseGameModeRegExp),
    config: zod.object({
        id: zod.number(),
        mode: zod
            .string()
            .regex(getUsersSelfSelfIdGameGuessLineResponseConfigModeRegExp),
        onlyFavoriteArtists: zod.boolean(),
        fromArtists: zod.array(zod.string()),
    }),
});
...
export const postUsersSelfSelfIdGameGuessLineGameIdAttemptsResponseGuessLineHintsItemRegExp =
    new RegExp("^(Correct spot|Correct letter, wrong spot\\.|Wrong)$");

export const postUsersSelfSelfIdGameGuessLineGameIdAttemptsResponse =
    zod.object({
        guessLineHints: zod.array(
            zod
                .string()
                .regex(
                    postUsersSelfSelfIdGameGuessLineGameIdAttemptsResponseGuessLineHintsItemRegExp
                )
        ),
        input: zod.string(),
        won: zod.boolean(),
