 ...
 */
export const deleteUsersSelfSelfIdConfigsPopdleConfigIdParams = zod.object({
    selfId: zod.number(),
    popdleConfigId: zod.number(),
});

export const deleteUsersSelfSelfIdConfigsPopdleConfigIdResponseModeRegExp =
    new RegExp("^(guessLine|guessSong)$");

export const deleteUsersSelfSelfIdConfigsPopdleConfigIdResponse = zod.object({
    id: zod.number(),
    mode: zod
        .string()
        .regex(deleteUsersSelfSelfIdConfigsPopdleConfigIdResponseModeRegExp),
    onlyFavoriteArtists: zod.boolean(),
    fromArtists: zod.array(zod.string()),
    fromTracks: zod.array(zod.string()),
});
 ...
 */
export const putUsersSelfSelfIdConfigsPopdleConfigIdParams = zod.object({
    selfId: zod.number(),
    popdleConfigId: zod.number(),
});

export const putUsersSelfSelfIdConfigsPopdleConfigIdResponseModeRegExp =
    new RegExp("^(guessLine|guessSong)$");

export const putUsersSelfSelfIdConfigsPopdleConfigIdResponse = zod.object({
    id: zod.number(),
    mode: zod
        .string()
        .regex(putUsersSelfSelfIdConfigsPopdleConfigIdResponseModeRegExp),
    onlyFavoriteArtists: zod.boolean(),
    fromArtists: zod.array(zod.string()),
    fromTracks: zod.array(zod.string()),
});
